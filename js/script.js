...
function modalContent(modalId) {
  ...
  var modalTableContentColumns = document.querySelectorAll(
    ".modalTable_column"
  );
...
function startGameSettings() {
  ...
  outputMessages.innerHTML =
    "Make your move! You have: " +
    roundsNumberInput.value +
    " rounds to win!" +
    "<br>" +
    "Try your luck!"; // info about rounds required to win
...
function winTournament() {
  ...
  if (
    params.cpuPoints == params.rounds ||
    ...
    score("noOne", "noPoint");
    outputMessages.innerHTML =
      "Click 'new game' to start" + "<br>" + "Try your luck!";
